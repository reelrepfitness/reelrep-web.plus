"use client"
/// <reference path="../../types/pixel-canvas.d.ts" />
...
// PixelCanvas web component - only define in browser
let PixelCanvasElement: typeof HTMLElement | undefined
    ...
    `
        ...
        connectedCallback() {
            ...
            if (!this._isMobile) {
                ...
                // Mobile: intersection observer for scroll-based activation
                this._intersectionObserver = new IntersectionObserver(
                    (entries) => {
                        entries.forEach((entry) => {
                            ...
                            } else if (!entry.isIntersecting && this._isVisible) {
                ...
                this._intersectionObserver.observe(this._parent || this)
            }
        }

        private handleMouseEnter = () => this.handleAnimation("appear")
        private handleMouseLeave = () => this.handleAnimation("disappear")
        private handleFocus = () => this.handleAnimation("appear")
        private handleBlur = () => this.handleAnimation("disappear")
...
// Extend JSX types for custom element
declare global {
...
const PixelCanvas = React.forwardRef<HTMLDivElement, PixelCanvasProps>(
    ({ gap, speed, colors, variant, noFocus, style, ...props }, ref) => {
        ...
        return (
            // @ts-expect-error - pixel-canvas is a custom element defined via customElements.define
            <pixel-canvas
